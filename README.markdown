...
2. `cd /srv/www/altrac`
3. `git pull`
   - This step will not really update the site contents but it _could_ result in changes, for instance, if the css has changed, `git pull` will apply that change immediately.
4. `~/bin/soupault`
